...
- Improved FR dump robustness with all watchdog broadcast wait, reduce dump timeout and shrinked mutex range ([#150652](https://github.com/pytorch/pytorch/pull/150652), [#151329](https://github.com/pytorch/pytorch/pull/151329), [#155949](https://github.com/pytorch/pytorch/pull/155949))
...
- Made FR vendor neutral so that other backends can use it and integrated into gloo. ([#152585](https://github.com/pytorch/pytorch/pull/152585), [#152563](https://github.com/pytorch/pytorch/pull/152563), [#154929](https://github.com/pytorch/pytorch/pull/154929), [#152614](https://github.com/pytorch/pytorch/pull/152614))
...
- Added support for `reduce_scatter` and `ReduceOp::AVG` in `ProcessGroupGloo` ([#149781](https://github.com/pytorch/pytorch/pull/149781), [#149869](https://github.com/pytorch/pytorch/pull/149869))
- Added FP8 support in `ProcessGroupNCCL` ([#152706](https://github.com/pytorch/pytorch/pull/152706))
- Added `ibverbs` backend in gloo and enabled gloo CUDA when used with a backend that supports `GPUDirect` ([#153015](https://github.com/pytorch/pytorch/pull/153015), [#153425](https://github.com/pytorch/pytorch/pull/153425), [#153406](https://github.com/pytorch/pytorch/pull/153406))
...
- Added `PrivateUse1` backend in FSDP collectives and device type to pre forward hook ([#147260](https://github.com/pytorch/pytorch/pull/147260), [#149487](https://github.com/pytorch/pytorch/pull/149487))
...
- Respected `reshard_after_forward=True` for root model and kept root unsharded when not specifying `reshard_after_forward` ([#154704](https://github.com/pytorch/pytorch/pull/154704), [#155319](https://github.com/pytorch/pytorch/pull/155319))
...
- Fixed connection reset in tcp store ([#150987](https://github.com/pytorch/pytorch/pull/150987), [#151052](https://github.com/pytorch/pytorch/pull/151052))
- Fixed unused `group` input argument in `new_subgroups()` ([#152765](https://github.com/pytorch/pytorch/pull/152765), [#153798](https://github.com/pytorch/pytorch/pull/153798))
- Fixed tcp init when using port 0 ([#154156](https://github.com/pytorch/pytorch/pull/154156))
- Adopted a vector to temporarily keep the reference to future object to avoid blocking inside Flight Recorder ([#156653](https://github.com/pytorch/pytorch/pull/156653))

#### Distributed Checkpointing (DCP)
- Fixed to use global coordinator rank in `broadcast_object` util function ([#155912](https://github.com/pytorch/pytorch/pull/155912))
...
- Documented `get_default_backend_for_device` ([#158236](https://github.com/pytorch/pytorch/pull/158236))
...
- Added logger config and more loggings, e.g. `nccl_version` and thread name/id, for flight record in PGNCCL ([#150356](https://github.com/pytorch/pytorch/pull/150356), [#150513](https://github.com/pytorch/pytorch/pull/150513), [#151048](https://github.com/pytorch/pytorch/pull/151048), [#152648](https://github.com/pytorch/pytorch/pull/152648), [#155142](https://github.com/pytorch/pytorch/pull/155142), [#155754](https://github.com/pytorch/pytorch/pull/155754))
...
- Updated error message in `get_backend()` with more details ([#141796](https://github.com/pytorch/pytorch/pull/141796))
